  ...
  div.innerHTML = `
    ...
    <div class="ad-main">
      ...
      <div class="ad-meta" style="margin-top:8px">
        ...
        ${
          totalSeats !== null
            ? `<div class="ad-chip">👥 ${escapeHtml(available)}/${escapeHtml(totalSeats)} bo‘sh</div>`
            : requested !== null
              ? `<div class="ad-chip">👥 ${escapeHtml(requested)} odam</div>`
...
async function openAdModal(ad) {
  ...
  modal.innerHTML = `
    <div class="ad-modal-box" role="dialog" aria-modal="true">
      ...
      <div class="modal-row">
        <div class="modal-col">
          ...
          <div class="value">
            ${
              totalSeats !== null
                ? `${escapeHtml(totalSeats)} ta (Bo‘sh: ${escapeHtml(available)})`
                : requested !== null
                  ? `Talab: ${escapeHtml(requested)} odam`
                  : "-"
            }
          </div>
        </div>
      ...
      <!-- CREATED AT -->
      <div style="margin-top:14px; color:#88919a; font-size:13px;">
...
document.addEventListener("change", (e) => {
  if (
    e.target &&
    (e.target.classList.contains("fromDistrict") ||
