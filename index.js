...
function attachInputsOnce() {
  ...
  if (!resetBtn) {
    ...
    if (filtersDiv) {
      ...
      // insert after role select (if exists) or at end
...
// ===============================
// RENDER ADS (full pipeline + pagination)
// ===============================
...
// ===============================
// DEBOUNCE scheduling to avoid flicker (single definition)
// ===============================
...
// ===============================
// PAGINATION CONTROLS (uses #pagination from your HTML)
// ===============================
